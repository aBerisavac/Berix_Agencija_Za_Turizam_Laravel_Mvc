...
--
-- Host: localhost
-- Generation Time: May 11, 2022 at 08:02 PM
-- Server version: 10.4.22-MariaDB
-- PHP Version: 8.1.2

create database berix_agency;
...
INSERT INTO `hotels` (`id`, `name`, `price_per_night`) VALUES
(1, 'Yildirim Bora 2*', 10),
(2, 'Scala Nuova 3*', 12),
(3, 'Hotel Cankaya 3*', 11),
(4, 'Akerdem 3*', 14),
(5, 'Palm 4*', 17),
(6, 'Filipos 2*', 10),
(7, 'Studio Apostolis 2* ', 10),
(8, 'Borsalino Studios 2*', 11),
(9, 'Vula 2*', 8),
(10, 'Gatsulis 2*', 9),
(11, 'Stelios 2*', 11),
(12, 'Lila House 2*', 13);
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `password`, `phone_number`, `role_id`) VALUES
(14, 'admin', 'admin', 'admin@admin.com', '$2y$10$aA64mvrS88E.6roTWQTrtOoO6QNk3GzF067TNe8S19HZVwyPczbtm', '+381552817482917', 1);
